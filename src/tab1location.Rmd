...
write.xlsx(tab1, paste0("./output/tabs/Baseline characteristics_location", Sys.Date(), ".xlsx"), rowNames = FALSE)
...
footnote(
  default_kable(tab1,
    font_size = 5,
    caption = "Baseline characteristics - Location",
    longtable = TRUE,
    escape = FALSE
  ) %>%
    add_header_above(c(" " = 1, " " = 1, "Out-patient" = 4, "In-patient" = 4)),
  general = c(
