...
write.xlsx(tab1, paste0("./output/tabs/Baseline characteristics_substudy13_", Sys.Date(), ".xlsx"), rowNames = FALSE)
...
colnames(tab1) <- sanitize_text(c("Variable", "Missing (%)", levels(rsdata$sos_lm_arni3), "p-value", "SMD"))

footnote(
  default_kable(tab1,
    font_size = 5,
    caption = "Baseline characteristics - Substudy 1, 3 groups",
    longtable = TRUE,
    escape = FALSE
  ),
  general = c(
