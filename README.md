# R code for the project Implementation, Timing and Modalities of Initiation/Up-Titration of ARNI in a Swedish real world Heart Failure population with Reduced Ejection Fraction
