...
write.xlsx(tab1, paste0("./output/tabs/Baseline characteristics_substudy2npr_", Sys.Date(), ".xlsx"), rowNames = FALSE)
...
footnote(
  default_kable(tab1,
    font_size = 5,
    caption = "Baseline characteristics - Substudy 2, NPR population",
    longtable = TRUE,
    escape = FALSE
  ),
  general = c(
