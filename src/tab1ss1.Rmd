...
write.xlsx(tab1both, paste0("./output/tabs/Baseline characteristics_substrudy1_", Sys.Date(), ".xlsx"), rowNames = FALSE)

footnote(
  default_kable(tab1both,
    font_size = 5,
    caption = "Baseline characteristics - Substudy 1",
    longtable = TRUE,
    escape = FALSE
  ) %>%
