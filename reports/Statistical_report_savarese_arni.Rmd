...
For substudy 3 seperate logistic regressions were estimated for HF duration strata. 
...
For substudy 3 an interaction effect between HF duration and ARNi use was included in the model 
...
Substudy 1, Overall cohort: The median (min-max) follow-up is 
`r rsdata %>% 
...
Substudy 1, Matched cohort: The median (min-max) follow-up is 
`r rsdata  %>% 
...
Substudy 3: The median (min-max) follow-up is 
