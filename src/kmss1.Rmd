...
kmfunc <- function(time, event, eventmod = NULL, eventname, ymax = 1, rep = FALSE) {
  ...
  legend(
    x = 2.35 * 365, y = ymax + 0.05, c("HR (95% CI), p-value", "ref", hrprintcrude, "ref", hrprintadj),
...
```{r kmcvdhhfhss1, fig.cap="CVD/First HF hospitalization - Substudy 1", cache=cacheon, dependson="kmfuncss1", fig.width=8, fig.height=7}
kmfunc(
...
```{r kmacvdss1, fig.cap="CVD - Substudy 1", cache=cacheon, dependson="kmfuncss1", fig.width=8, fig.height=7}
kmfunc(
...
```{r kmhfhss1, fig.cap="First HF hospitalization - Substudy 1", cache=cacheon, dependson="kmfuncss1", fig.width=8, fig.height=7}
kmfunc(
  time = "sos_outtime_hosphf",
...
```{r kmtotcvdhfhss1, fig.cap="CVD/Total HF hospitalization - Substudy 1", cache=cacheon, dependson="kmfuncss1", fig.width=8, fig.height=7}
kmfunc(
  event = "sos_out_deathcvhosphf",
...
```{r kmtothfhss1, fig.cap="Total HF hospitalization - Substudy 1", cache=cacheon, dependson="kmfuncss1", fig.width=8, fig.height=7}
kmfunc(
  event = "sos_out_hosphf",
...
```{r kmdeathss1, fig.cap="All-cause mortality - Substudy 1", cache=cacheon, dependson="kmfuncss1", fig.width=8, fig.height=7}
kmfunc(
  time = "sos_outtime_death",
  event = "sos_out_death",
