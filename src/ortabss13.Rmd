...
```{r orforestss13, cache=cacheon, dependson=c("ortabss13"), fig.width=6, fig.height=10, fig.cap="Adjusted associations between ARNi use and characteristics - Substudy 1, 3 groups"}
