...
write.xlsx(predallprint, paste0(
  "./output/tabs/Associations between ARNi use and characteristics_substudy1_", Sys.Date(), ".xlsx"
), rowNames = FALSE, overwrite = TRUE)

default_kable(predallprint,
  font_size = 6,
  caption = "Associations between ARNi use and characteristics - Substudy 1",
  escape = T
) %>%
  add_header_above(c(" " = 1, "Crude" = 2, "Adjusted" = 2))
```

```{r orforestss1, cache=cacheon, dependson=c("ortabss1"), fig.width=5, fig.height=10, fig.cap="Adjusted associations between ARNi use and characteristics - Substudy 1"}
