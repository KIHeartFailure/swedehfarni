...
colnames(tab1) <- sanitize_text(c("Variable", "Missing (%)", "No ARNi", "ARNi", "p-value", "SMD"))

write.xlsx(tab1, paste0("./output/tabs/Baseline characteristics_substrudy2_", Sys.Date(), ".xlsx"), rowNames = FALSE)

footnote(
  default_kable(tab1,
    font_size = 5,
    caption = "Baseline characteristics - Substudy 2",
    longtable = TRUE,
    escape = FALSE
  ),
  general = c(
